...
"}")
        ...
        self.search_buttoin = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        font = QtGui.QFont()
        font.setFamily("Comfortaa")
        font.setPointSize(14)
        self.search_buttoin.setFont(font)
        self.search_buttoin.setStyleSheet("QPushButton {\n"
"background-color: #0A74F0;\n"
"color: white; \n"
"border-radius: 14px;\n"
"\n"
...
"background-color: #0559F0;\n"
"}")
        self.search_buttoin.setObjectName("search_buttoin")
        self.horizontalLayout_2.addWidget(self.search_buttoin)
